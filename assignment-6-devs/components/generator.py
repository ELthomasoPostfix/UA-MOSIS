...
class GeneratorState:
    ...
    latest_departure_time: float = INFINITY
    """The latest simulated time that a Car departed. This can be interpreted as the final departure time at the end of a simulation. Defaults to INFINITY, because all Cars should have a finite departure time. The simulated time timer cannot be used as such, because unrelated input events will also increase the simulated time."""
...
class Generator(AtomicDEVS):
    ...
    def intTransition(self):
        ...
        # Car was output, schedule next car generation
            ...
            self.state.n += 1
            self.state.latest_departure_time = self.state.simulated_time
